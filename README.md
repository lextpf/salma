...
[![rust](https://github.com/lextpf/salma/actions/workflows/rust.yml/badge.svg)](https://github.com/lextpf/salma/actions/workflows/rust.yml)
...
|   |-- workflows/                        # rust.yml, build.yml, test.yml, sonar.yml, eslint.yaml
